    ...
    <header className="h-[60px] bg-white border-b border-[#E5E2DC] flex items-center px-6 gap-4 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4 ml-auto">
        ...
        >
          ...
          <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 bg-[#ED8D31] rounded-full border border-white text-white text-[10px] font-bold flex items-center justify-center">
            3
          </span>
        </button>
        ...
        <div className="flex items-center gap-2.5">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-xs text-[#7A8088] leading-tight">Employee</p>
          </div>
